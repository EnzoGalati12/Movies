...
class PersonPopularModel {
    ...
    factory PersonPopularModel.fromRawJson(String str) => PersonPopularModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory PersonPopularModel.fromJson(Map<String, dynamic> json) => PersonPopularModel(
        page: json["page"],
